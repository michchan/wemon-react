...
window.RTCMultiConnection = function(roomid, forceOptions) {
    ...
    var StreamsHandler = (function() {
        ...
        function setHandlers(stream, syncAction, connection) {
            ...
            stream.mute = _.throttle(function(type, isSyncAction) {
                console.info('mute stream', stream);
            ...
            stream.unmute = _.throttle(function(type, isSyncAction) {
                type = handleType(type);
                console.info('unmute stream');
